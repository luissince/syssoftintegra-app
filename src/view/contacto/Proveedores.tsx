...
const Proveedores = (props: RouteComponentProps<{}>) => {

    const divModal = useRef<HTMLDivElement>()

    useEffect(() => {
        viewModal("modalProveedor", () => {
            // 
        })

        clearModal("modalProveedor", () => {
    ...
    const openModal = () => {
        const modalInstance = document.getElementById("modalProveedor") as HTMLDivElement
    ...
    return (
        <>
            ...
            {/* Inicio modal */}
            <div className="modal fade" id="modalProveedor" data-backdrop="static">
                <div className="modal-dialog">

                    <div className="modal-content">

                        <div className="modal-header">
                            <h4 className="modal-title" id="lblTitleCrud">Agregar Proveedor</h4>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="tile p-0 border-0">
                                ...
                                <div className="overlay p-5 d-none" id="divOverlayCrudProveedor">
                                    <div className="m-loader mr-4">
                                        <svg className="m-circular" viewBox="25 25 50 50">
                                            <circle className="path" cx="50" cy="50" r="20" fill="none" strokeWidth="4" strokeMiterlimit="10"></circle>
                                        </svg>
                                    </div>
                                    <h4 className="l-text text-center text-white p-10" id="lblTextOverlayCrudProveedor">Cargando información...</h4>
                                </div>
                                ...
                                <div className="bs-component">
                                    ...
                                    <div className="tab-content">
                                        ...
                                        <div className="tab-pane fade show active p-2" id="tabPrimero">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                    <div className="form-group">
                                                        ...
                                                        <div className="input-group">
                                                            <input id="txtPage" className="form-control" type="text" placeholder="Ingrese su Página Web"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div className="app-title">
                <h1><i className="fa fa-folder"></i> Proveedores  <small>Lista</small></h1>
            </div>
                                ...
                                <table className="table table-striped" style={{ borderWidth: "1px", borderStyle: "dashed", borderColor: "#007bff" }}>
                                    ...
                                    <tbody id="tbList">
                                        <tr>
                                            ...
                                            <td className="text-left">PROVEEDOR GENERAL</td>
